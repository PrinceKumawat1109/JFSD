...
<h1 style=" color: red; margin-left: 250px;">ADD A NEW POSITION</h1>
	...
	<input style="margin-left: 50px; margin-top: 20px; height: 25px; width: 250px;" type="text" id="t10"/>
	<button style="height: 20px; width: 100px; margin-top: -10px;" onclick="save1()">Save and Publish</button>
	</div>
...
function save1()
{
	...
	xhtml.onreadystatechange = function()
	{
		if(this.readyState == 4 && this.status == 200)
			...
			window.location="https://app-0011.azurewebsites.net/dashboard.jsp";
	};
}
</script>
</body>
