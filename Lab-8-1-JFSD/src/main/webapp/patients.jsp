...
<body>
	<h3>KL - Hospital Patient Details</h3>
	<p>Patient Id : <input type="text" id="t1" required/></p>
	...
	<p>Any health Issues : <input type="text" id="t5" required/></p>
...
<script type="text/javascript">
	function save()
	{
		...
		var url = "http://localhost:8080/api/patient";
	...
	function update()
	{
		...
		var t5 = document.getElementById("t5");
		var t6 = document.getElementById("t6");
		var url = "http://localhost:8080/api/patient/"+t1.value;
